              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src={{$user->avatar ? asset('/storage/'.$user->avatar) : asset('img/noavatar.png')}} alt="Admin" class="rounded-circle bg-light border border-secondary" width="150" height="150">
                    <div class="mt-3">
                      <h4>{{$user->name}}</h4>
